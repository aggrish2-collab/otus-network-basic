...
MAC-адреса портов F0/1 коммутаторов (`show interface f0/1`, поле bia):

```
S1 Fa0/1: 0090.2111.8c01
S2 Fa0/1: 0001.c9b1.cd01
```

**Вопрос: назовите адреса оборудования (bia) во второй строке вывода.**

MAC S1 Fa0/1: 0090.2111.8c01, MAC S2 Fa0/1: 0001.c9b1.cd01.
